...
alter table cache_crc_balances_by_safe_and_token add column token_owner_address_id int;

truncate table cache_crc_balances_by_safe_and_token;
...
alter table cache_crc_current_trust add column user_address_id int;
alter table cache_crc_current_trust add column user_token_address_id int;
alter table cache_crc_current_trust add column can_send_to_address_id int;
alter table cache_crc_current_trust add column can_send_to_token_address_id int;

truncate table cache_crc_current_trust;
