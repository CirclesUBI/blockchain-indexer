...
public static class Statistics
{
    ...
    {
        if (_blockRuntimes.Count > 100)
        {
            Console.Error.WriteLine($"TrackBlockEnter() isn't followed by TrackBlockWritten() somewhere. Item count > 100. Clearing _blockRuntimes ..");
            _blockRuntimes.Clear();
        }
